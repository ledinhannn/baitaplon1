...
struct Student{
	string name, mssv,gtinh,ngaysinh;

	double gpa;
float diem1;
float diem2;
float diemck,diemcc,diemgk;
...
sv makeNode(){
	...
	getline(cin, s.name);
cout<<"Gioi tinh :"; cin>>s.gtinh;
cout <<"ngay sinh :"; cin>>s.ngaysinh;
cout<< "Nhap diem kiem tra lan 1:";cin>>s.diem1;
cout<< "Nhap diem kiem tra lan 2:";cin>>s.diem2;
cout<< "Nhap diem chuyen can:";cin>>s.diemcc;
cout<< "Nhap diem giua ki :";cin>>s.diemgk;
cout<< "Nhap diem diem cuoi ki :";cin>>s.diemck;


s.gpa=(s.diem1*0.2)+(s.diem2*0.2)+(s.diemcc*0.1)+(s.diemgk*0.2)+(s.diemck*0.3);
...
void in(Student s){
    ...
    cout <<"Gioi tinh "<<s.gtinh<<endl;
    cout<<"ngaysinh"<<s.ngaysinh<<endl;
	cout << "Diem trung binh : " << fixed << setprecision(2) <<s.gpa<< endl; 
	cout << "--------------------------------\n";
}
